...
public class DummyWorldManager {
    ...
    private static DamageSources allocateDamageSources() {
        try {
            ...
            CharacterSelection.LOGGER.error("[CharSel] Falha ao alocar DamageSources fake:", e);
            return null;
        }
    }
    ...
    public static ClientWorld getDummyWorld() {
        ...
        if (dummyWorld == null) {
            CharacterSelection.LOGGER.error("[CharSel] Falha ao criar dummyWorld — veja erro acima");
        }
        return dummyWorld;
    }
    ...
    private static ClientWorld buildFakeWorld(MinecraftClient client) {
        try {
            ...
            CharacterSelection.LOGGER.info("[CharSel] Mundo falso criado com sucesso.");
            return world;
        } catch (Throwable e) {
            CharacterSelection.LOGGER.error("[CharSel] Falha ao criar mundo falso:", e);
            return null;
        }
    }
