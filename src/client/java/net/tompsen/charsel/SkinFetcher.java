    ...
    public static void fetchByUsername(String username, SkinCallback callback) {
        Thread thread = new Thread(() -> {
            try {
                ...
                CharacterSelection.LOGGER.info("[CharSel] Profile response: {}", profileJson);
                ...
                CharacterSelection.LOGGER.info("[CharSel] Skin response (truncated): {}",
                ...
                CharacterSelection.LOGGER.error("[CharSel] SkinFetcher error:", e);
